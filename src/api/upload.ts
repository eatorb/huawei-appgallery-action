...
export const getUploadUrl = async (token: string, clientId: string, appId: string, filePath: string): Promise<UploadInfo> => {
...
export const uploadFile = async (uploadUrl: string, headers: Record<string, string>, filePath: string): Promise<void> => {
